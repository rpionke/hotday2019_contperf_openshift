...
if [ `id -u` -ge 10000 ]; then
	...
	echo "neoload:x:`id -u`:`id -g`:,,,:/home/jenkins:/bin/bash" >> /tmp/passwd
...
if [[ "${MODE}" == "Managed" ]]; then
    source /home/jenkins/controller-agent-entrypoint.sh
    runAgent
else
    source /home/jenkins/controller-entrypoint.sh
    runController
fi
